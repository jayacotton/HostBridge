...
//TODO: int circular_buf_get_range(circular_buf_t cbuf, unsigned char *data, int len);
//TODO: int circular_buf_put_range(circular_buf_t cbuf, unsigned char * data, int len);
